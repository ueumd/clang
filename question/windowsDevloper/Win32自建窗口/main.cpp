...
/*
系统保留消息ID的值在0X0000在0X03FF范围，这些值为系统所保留定义，用户自定义消息ID不能够与其相冲突。用户自定义消息ID范围为从WM_USER（0X0400）到0X7FFF，或0XC000到0XFFFF。Windows消息ID概览如下：
...
0X8000：用户自定义消息的起点，WM_APP，以WM_APP + N形式出现。

0X0400----0X7FFF：用户自定义消息范围。

0X8001----0XBFFF，0xC000----0xFFFE：用户自定义消息范围。
*/
